...
`brain-audit` provides an automated, rigorous sweep of your cognitive surface to ensure 100% referential integrity and zero security leaks.
...
1. `brain-audit-report.md` — Complete audit breakdown of link integrity, secret sweep, frontmatter health, and remediations.
