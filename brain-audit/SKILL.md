...
metadata:
  hermes:
    ...
    related_skills: [evidence-ledger, updateagents, new-project, dead-letter]
...
### Step 5 — Emit Audit Report (`brain-audit-report.md`)
...
4. [ ] `brain-audit-report.md` reports zero critical blockers.
