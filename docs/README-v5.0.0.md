...
flowchart TD
    ...
    subgraph L2 ["2. Foundation & Scaffolding Engine"]
        direction TB
        Bounds --> Scaffolder["🚀 new-project (#5) & 🤖 ai-ready (#7)<br/>Project OS Scaffolder & Fast-Skip"]
        Scaffolder --> Memory["🧠 updateagents (#2) & 📚 updatedocs (#1)<br/>Workspace Memory & Doc Governance"]
    end

    subgraph L3 ["3. Execution, Design & Quality Gates"]
        direction TB
        Memory --> Design["🎨 designscope (#11) & 🪄 refactor (#10)<br/>Design Tokens, Responsive Trees & UI States"]
