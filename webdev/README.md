...
The web engineering department head: one skill, eleven modes — frontend, backend, fullstack, ecommerce, cms, performance, accessibility, migrations, prototype, spec, implement. Stack-agnostic: uses what the project uses.
