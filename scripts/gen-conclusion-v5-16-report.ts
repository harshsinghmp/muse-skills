...
<div class="container">
  ...
  <section>
    ...
    <div class="council-grid">
      ...
      <div class="persona-card persona-crew">
        ...
        <p style="font-size: 0.85rem; color: var(--text-muted);">
          End-to-end client lifecycle governance: 50-point intake audits, BANT/MEDDIC sales qualification, LifeOS zero-leak access delegation, legal contracts (SOW/NDA/MSA), inbox triage, and multi-gateway clearing (OpenAccountants).
        </p>
        <div class="skill-pills">
  ...
  <footer>
    <div>Generated by <strong>Muse Orchestrator</strong> · LifeOS Agency Council</div>
